...
export const getFeaturedTools = cache(
   async (): Promise<GetFeaturedToolsResponse> => {
      const session = await getServerSession(authOptions);

      const featuredTools = await withDb(() =>
...
export const getFeaturedBlogPosts = cache(
   async (): Promise<GetFeaturedBlogPostsResponse> => {
...
// Tools page data
export const getAllTools = cache(async (): Promise<GetAllToolsResponse> => {
   const session = await getServerSession(authOptions);
...
export const getAllCategories = cache(
   async (): Promise<GetAllCategoriesResponse> => {
      const categories = await withDb(() =>
         prisma.category.findMany({
            include: {
               _count: {
...
export const getToolDetail = cache(
   async (slug: string): Promise<GetToolDetailResponse> => {
      const session = await getServerSession(authOptions);
...
export const getAllBlogPosts = cache(
   async (): Promise<GetAllBlogPostsResponse> => {
      const posts = await withDb(() =>
         prisma.blog.findMany({
            where: {
               published: true,
...
export const getFeaturedBlogPostsForSlider = cache(
   async (): Promise<GetFeaturedBlogPostsForSliderResponse> => {
...
export const getBlogCategories = cache(
   async (): Promise<GetBlogCategoriesResponse> => {
...
export const getBlogTags = cache(async (): Promise<GetBlogTagsResponse> => {
...
export const getBlogPostDetail = cache(
   async (slug: string): Promise<GetBlogPostDetailResponse> => {
      const session = await getServerSession(authOptions);
      ...
      const relatedPosts = await withDb(() =>
         prisma.blog.findMany({
            where: {
               id: { not: post.id },
               published: true,
...
export const getPricingPlans = cache(
   async (): Promise<GetPricingPlansResponse> => {
      const session = await getServerSession(authOptions);

      const plans = await withDb(() =>
